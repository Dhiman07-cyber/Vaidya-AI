...
const styles = {
  ...
  toolBtn: "bg-white dark:bg-slate-800 border-2 border-slate-300 dark:border-slate-600 rounded-xl px-4 py-6 cursor-pointer transition-all flex flex-col items-center gap-2 hover:border-medical-indigo hover:-translate-y-0.5 hover:shadow-lg shadow-sm",
  ...
  error: "bg-red-50 dark:bg-red-900/20 text-red-700 dark:text-red-400 p-4 rounded-lg mb-4 border-l-4 border-red-600 dark:border-red-500 font-medium",
  resultCard: "bg-white dark:bg-slate-800 rounded-xl p-8 shadow-lg border border-slate-300 dark:border-slate-600",
  resultHeader: "flex justify-between items-center mb-6 pb-4 border-b-2 border-slate-300 dark:border-slate-600",
  clearBtn: "bg-slate-100 dark:bg-slate-700 border-2 border-slate-300 dark:border-slate-600 px-4 py-2 rounded-lg cursor-pointer transition-all hover:bg-slate-200 dark:hover:bg-slate-600 hover:border-slate-400 font-semibold text-slate-700 dark:text-slate-200",
  resultContent: "whitespace-pre-wrap leading-relaxed text-slate-800 dark:text-slate-100 text-base",
  citations: "mt-8 pt-6 border-t-2 border-slate-300 dark:border-slate-600",
  citation: "bg-slate-100 dark:bg-slate-700 px-4 py-3 rounded-lg mb-2 text-slate-700 dark:text-slate-200 font-medium border border-slate-300 dark:border-slate-600",
  placeholder: "text-center py-16 px-8 text-slate-600 dark:text-slate-300",
