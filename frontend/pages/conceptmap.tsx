...
const styles = {
  ...
  sidebar: "bg-white rounded-xl p-4 shadow-md border border-slate-300 overflow-y-auto h-fit max-h-full max-[1024px]:order-2",
  sessionList: "flex flex-col gap-2",
  sessionItem: "p-3 bg-slate-100 rounded-lg cursor-pointer transition-all relative border border-slate-300 hover:bg-slate-200 hover:border-slate-400",
  active: "bg-gradient-to-br from-medical-indigo to-[#5a67d8] text-white border-medical-indigo shadow-md",
  sessionTitle: "font-bold mb-1 text-xs overflow-hidden text-ellipsis whitespace-nowrap pr-6",
  sessionDate: "text-xs opacity-90",
  deleteBtn: "absolute top-1/2 right-2 -translate-y-1/2 bg-transparent border-0 rounded px-1.5 py-0.5 cursor-pointer text-xs opacity-0 transition-all hover:opacity-100 hover:bg-red-500/20 font-bold",
  emptyState: "text-center py-6 px-3 text-slate-600 text-sm font-medium",
  mainContent: "bg-white rounded-xl p-4 shadow-md border border-slate-300 flex flex-col min-h-0 overflow-hidden max-[1024px]:order-1 max-[1024px]:min-h-[500px]",
  inputSection: "flex gap-3 mb-4 flex-shrink-0 max-[640px]:flex-col",
  searchBox: "flex-1 flex items-center bg-slate-50 border-2 border-slate-300 rounded-[10px] px-4 transition-all focus-within:border-medical-indigo focus-within:bg-white focus-within:shadow-[0_0_0_3px_rgba(102,126,234,0.1)]",
  searchIcon: "text-base mr-3 text-slate-500",
  topicInput: "flex-1 py-3 border-0 bg-transparent text-base outline-none text-slate-900 placeholder:text-slate-400 font-medium",
  generateBtn: "bg-gradient-to-br from-medical-indigo to-[#5a67d8] text-white border-0 px-6 py-3 rounded-[10px] text-base font-bold cursor-pointer transition-all whitespace-nowrap hover:bg-gradient-to-br hover:from-[#5a67d8] hover:to-[#4c51bf] hover:-translate-y-px hover:shadow-[0_6px_16px_rgba(102,126,234,0.5)] disabled:opacity-50 disabled:cursor-not-allowed max-[640px]:w-full shadow-md",
  ...
  placeholder: "flex-1 flex flex-col items-center justify-center text-slate-600 bg-slate-50 rounded-xl",
  placeholderIcon: "text-[3.5rem] mb-4 opacity-60",
  rightSidebar: "bg-white rounded-xl p-4 shadow-md border border-slate-300 overflow-y-auto h-fit max-h-full max-[1024px]:order-3",
  summaryCard: "flex flex-col gap-4",
  topicIcon: "flex justify-center",
  iconCircle: "w-16 h-16 bg-gradient-to-br from-[#ffeef5] to-[#ffe4ec] rounded-full flex items-center justify-center text-[1.75rem] shadow-sm",
  topicTitle: "text-center text-base text-slate-800 m-0 font-bold",
  statsSection: "flex flex-col gap-3.5 py-3.5 border-t border-b border-slate-300",
  statItem: "flex flex-col gap-1.5",
  statLabel: "text-xs text-slate-700 font-bold tracking-wide",
  statBadges: "flex flex-wrap gap-1.5",
  badge: "bg-blue-50 text-blue-700 px-2 py-1.5 rounded-[5px] text-xs font-bold border border-blue-300",
  treatmentList: "flex flex-col gap-1.5",
  treatmentItem: "bg-green-50 text-green-700 px-2 py-1.5 rounded-[5px] text-xs font-bold border border-green-300",
  legend: "pt-2",
  ...
  legendCount: "bg-slate-200 text-slate-700 px-1.5 py-0.5 rounded text-xs font-bold min-w-[24px] text-center"
}
